...
export const registeruser = (userData) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.post("https://project-demo-image1-tag1-1.onrender.com/api/users/signup", userData);
...
export const login = (userData) => async (dispatch) => {
    ...
    try {
      ...
      const { data } = await axios.post("https://project-demo-image1-tag1-1.onrender.com/api/users/login", userData);
...
export const getUser = () => async (dispatch) => {
   dispatch({ type: GET_USER_REQUEST });
    try {
        const { data } = await axios.get("https://project-demo-image1-tag1-1.onrender.com/api/users/profile", {
            headers: {
